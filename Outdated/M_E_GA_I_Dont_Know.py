...
config = {
    'genes': GENES,
    'fitness_function': lambda ind, ga: problem_specific_fitness_function(ind, ga, items, volume_bound=VOLUME, sack_capacity=100, verbose=False),
...
verbose_fitness_score, _ = problem_specific_fitness_function(ind, ga_inst, items)
