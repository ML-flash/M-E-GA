...
def generate_locations(num_locations, value_range=(10, 100), coord_range=(0, 100)):
    locations = {}
...
def problem_specific_fitness_function(encoded_individual, encoding_manager, total_days=90, verbosity=False):
...
config = {
    ...
    'capture_mutation_prob': 0.0008,
    'delimiter_insert_prob': 0.0001,
    'crossover_prob': 0.7,
    'elitism_ratio': 0.05,
    'base_gene_prob': 0.65,
